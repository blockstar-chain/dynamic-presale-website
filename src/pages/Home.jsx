...
export default function Home() {
    ...
    const { error, loading, website, header, hero, about, team, info, tokenomics, howToBuy, dex, presale, roadmap, social, cta, footer, chaininfo, presale_address } = useWebsiteStats(id);
    const allSocialLinks = social.defaultLinks || social.customLinks ? [...social.defaultLinks, ...social.customLinks] : [];
